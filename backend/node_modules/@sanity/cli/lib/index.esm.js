...
import require$$0$2 from 'get-it';
import require$$2$2 from 'get-it/lib/middleware/observable';
import require$$3$2 from 'get-it/lib/middleware/jsonRequest';
import require$$4$1 from 'get-it/lib/middleware/jsonResponse';
import require$$5 from 'get-it/lib/middleware/progress';
import require$$0$1 from 'get-it/lib-node/middleware/retry';
import require$$1$1 from 'get-it/lib-node/middleware/debug';
import require$$2$1 from 'get-it/lib-node/middleware/headers';
...
var polyfilledEventSource = nodeExports$1;
var pick = pick$1;
...
var retry = require$$0$1;
var debug$1 = require$$1$1;
var headers = require$$2$1;
var pkg = require$$3;
...
var getIt = require$$0$2;
var assign$2 = objectAssign;
var observable = require$$2$2;
var jsonRequest = require$$3$2;
var jsonResponse = require$$4$1;
var progress = require$$5;
...
function hasStudioConfig(basePath) {
  const buildConfigs = [fileExists(path.join(basePath, "studio.config.js")), fileExists(path.join(basePath, "studio.config.ts")), isSanityV2StudioRoot(basePath)];
...
export { createCliConfig, defineCliConfig, getCliClient };
